...
def parse_arguments(argv):
    ...
    parser.add_argument('--Input_dir', type=str, help='Input dir', default=r'F:\NanJinLandset\2013')
    parser.add_argument('--Output_dir', type=str, help='Output dir', default=r'D:\YAOGANGAILUN\NanJinNDVI_ChangeDetection\2013_process')
...
def MeanDEM(pointUL, pointDR):
    ...
    dem_path = os.path.join(script_path,"GMTED2km.tiff")
